...
<div class="profile-edit-container" style="max-width: 600px; animation: fadeIn 0.3s;">
    ...
    <!-- TỐI ƯU: Đưa hx-headers lên form và bọc bằng c:if sạch sẽ tránh lỗi chuỗi JSON trống -->
    <form hx-post="/api/user/update-profile" 
        ...
        <div class="d-flex gap-2">
            <!-- Nút Lưu thay đổi sạch sẽ, không gánh logic header nữa -->
...
/* Fix CSS: Lớp .htmx-request sẽ tự động được thêm vào FORM hoặc các phần tử kích hoạt AJAX */
