            ...
            <div id="player-container" class="fixed-bottom bg-dark text-white p-3 border-top border-secondary">
                <div class="container-fluid d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center w-25">
                        <img src="path/to/thumbnail.jpg" id="songThumb" class="rounded" width="50" height="50"
                            alt="Cover">
                    ...
                    <div class="d-flex flex-column align-items-center w-50">
                        <div class="d-flex align-items-center gap-3 mb-1">
                            ...
                            <button class="btn btn-link text-white fs-4" id="playPauseBtn"
                    ...
                    <div class="d-flex align-items-center gap-2 w-25 justify-content-end">
                        <input type="range" id="volumeRange" min="0" max="1" step="0.1" value="1"
                            oninput="setVolume(this.value)" style="width: 80px;">
                        <button id="loopBtn" class="btn btn-sm btn-outline-light" onclick="toggleLoopMode()"
                            title="Chế độ phát">🔀</button>


                        <div class="dropup">

                            <button class="btn btn-dark text-white fw-bold btn-sm"
                                hx-on:click="document.getElementById('lyricWrapper').classList.toggle('htmx-hidden')">
                                Lời ▴
                            </button>
                        ...
                        <div class="dropup">
                            <button class="btn btn-sm btn-outline-info dropdown-toggle" data-bs-toggle="dropdown"
                                onclick="updateQueueMenu()">☰</button>
