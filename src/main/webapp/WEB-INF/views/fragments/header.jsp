    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link" href="/" hx-get="/" hx-select="#songListBody tr" hx-target="#songListBody" hx-swap="innerHTML">Tất cả</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/favorite" hx-get="/favorite" hx-target="#songListBody">Yêu thích</a>
                </li>
            </ul>

            <div class="d-flex align-items-center">
                <form class="d-flex me-3" hx-get="/search" hx-target="#songListBody" hx-trigger="submit">
