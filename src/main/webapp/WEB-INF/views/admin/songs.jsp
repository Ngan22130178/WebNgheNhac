                        ...
                        <c:choose>
                            <c:when test="${not empty songs}">
                                <c:forEach var="song" items="${songs}">
                                    <tr id="row-song-${song.id}">
                                        <td>${song.id}</td>
                                        <td>${song.title}</td>
                                        <td><span class="badge bg-success">Đã đồng bộ</span></td>
                                        <td>
                                           <button type="button" class="btn btn-sm btn-outline-primary" 
                                                    data-bs-toggle="modal" data-bs-target="#editSongModal${song.id}">
                                ...
                                <c:forEach var="song" items="${songs}">
                                    ...
                                    <jsp:include page="editSongModal.jsp" />
                                </c:forEach>
                            </c:when>
                            <c:otherwise>
                                <tr>
...
function submitEditForm(event, formElement) {
    ...
    .then(data => {
        if (data === "success") {
            ...
            const modalEl = document.getElementById('editSongModal' + id);
